...
mssql_select_db("SAP_PROCESOS_DESARROLLO", $conn);
...
FROM SAP_PROCESOS_DESARROLLO.dbo.usuarios u
LEFT JOIN SAP_PROCESOS_DESARROLLO.dbo.usuario_rol ur
       ON ur.usuario_id = u.id
LEFT JOIN SAP_PROCESOS_DESARROLLO.dbo.roles r
       ON r.id = ur.rol_id
LEFT JOIN SAP_PROCESOS_DESARROLLO.dbo.usuarios creador
...
OUTER APPLY (
    SELECT
        tipo_conteo = (
            ...
            FROM SAP_PROCESOS_DESARROLLO.dbo.CAP_CONTEO_CONFIG c
