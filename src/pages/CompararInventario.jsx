  ...
  useEffect(() => {
   ...
   const obtenerComparacion = async () => {
    try {
      ...
      const hayDifMioVsSap = res.data.hay_dif_mio_vs_sap == true || res.data.hay_dif_mio_vs_sap == "1";
      const hayDifCompVsSap = res.data.hay_dif_comp_vs_sap == true || res.data.hay_dif_comp_vs_sap == "1";
