...
$nro_conteo_actual = $nro_conteo_param > 0
  ? $nro_conteo_param
  : (isset($rowAsig['nro_conteo']) ? intval($rowAsig['nro_conteo']) : 0);
...
$existe_conteo_actual = isset($rowConteos['total']) && intval($rowConteos['total']) > 0;
